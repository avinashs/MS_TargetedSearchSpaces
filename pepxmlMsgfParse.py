...
titleLine = "\t".join(["peptide","modpeptide","specid","mass","charge","rawscore","denovoscore","evalue","specEvalue","iniprob","isfwd","protidString"]);
out.write(titleLine+"\n");
...
for pepxrec in pepxitr:
	...
	rawscore = pepxrec['search_hit'][0]['search_score']['raw']
	denovoscore = pepxrec['search_hit'][0]['search_score']['denovo'];
	evalue = pepxrec['search_hit'][0]['search_score']['EValue'];
	specEvalue = pepxrec['search_hit'][0]['search_score']['SpecEValue'];


	iniprob = pepxrec['search_hit'][0]['analysis_result'][0]['peptideprophet_result']['probability'];
	...
	outstring = "\t".join(map(str,[peptide,modpeptide, specid, mass, charge, rawscore, denovoscore, evalue, specEvalue, iniprob, isfwd, protidString]));
